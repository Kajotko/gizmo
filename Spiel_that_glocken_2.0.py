#Should work for all 4 by 4 melodies
#Does account for single eighth notes
#does not account for full notes
#Notes played as drum is hit, eigths separated by half beat found from the time elapsed between last two drum hits
...
print i in range len(playlist)
i=raw_input('Choose a song number:')
song=playlist[i]
beat_times=[]
